 ...
 <head>
     <title>Virtual Tour - Inkindo Jatim Expo</title>
     <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
     <meta name="viewport" content="user-scalable=no, initial-scale=0.5, width=device-width, viewport-fit=cover" />
     {{-- <link rel="preload" href="{{ vista_asset('script.js?v=1733988824789') }}" as="script" /> --}}
     <link rel="preload"
         href="{{ vista_asset('media/panorama_3BA22A4C_379D_801C_41C5_A66908754F15_0/l/3/0_0.jpg?v=1733988824789') }}"
         as="image" />
     <link rel="preload"
         href="{{ vista_asset('media/panorama_3BA22A4C_379D_801C_41C5_A66908754F15_0/r/3/0_0.jpg?v=1733988824789') }}"
         as="image" />
     <link rel="preload"
         href="{{ vista_asset('media/panorama_3BA22A4C_379D_801C_41C5_A66908754F15_0/u/3/0_0.jpg?v=1733988824789') }}"
         as="image" />
     <link rel="preload"
         href="{{ vista_asset('media/panorama_3BA22A4C_379D_801C_41C5_A66908754F15_0/d/3/0_0.jpg?v=1733988824789') }}"
         as="image" />
     <link rel="preload"
         href="{{ vista_asset('media/panorama_3BA22A4C_379D_801C_41C5_A66908754F15_0/f/3/0_0.jpg?v=1733988824789') }}"
         as="image" />
     <link rel="preload"
         href="{{ vista_asset('media/panorama_3BA22A4C_379D_801C_41C5_A66908754F15_0/b/3/0_0.jpg?v=1733988824789') }}"
         as="image" />
     <script>
     ...
     <script src="{{ vista_asset('lib/tdvplayer.js?v=1733988824789') }}"></script>
     <script type="text/javascript">
         ...
         function loadTour() {
             ...
             settings.set(
                 ...
                 "{{ vista_asset('script.js?v=1733988824789') }}"
                 // "script.js?v=1733988824789"
             );
             settings.set(
                 TDV.PlayerSettings.WEBVR_POLYFILL_URL,
                 "{{ vista_asset('lib/WebVRPolyfill.js?v=1733988824789') }}"
                 // "lib/WebVRPolyfill.js?v=1733988824789"
             );
             settings.set(TDV.PlayerSettings.HLS_URL, "{{ vista_asset('lib/Hls.js?v=1733988824789') }}");
             settings.set(
     ...
     <link rel="stylesheet" href="{{ vista_asset('fonts.css?v=1733988824789') }}" />
 </head>
 ...
 <body onload="onLoad()">
     ...
     <div id="viewer"></div>
     <input type="hidden" id="data-master" value="{{ $data_master }}">
     <input type="hidden" id="data-user" value="{{ $data_user }}">
 </body>
